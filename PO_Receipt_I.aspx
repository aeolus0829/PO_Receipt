<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeFile="PO_Receipt_I.aspx.cs" Inherits="WKF_OptionalFields_PO_Receipt_I" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <colgroup class="PopTableRightTD">	</colgroup>
    <tr>
        <td align="center" class="PopTableHeader" colspan="4"><asp:Label ID="lblSingleLine" runat="server" Text="採購單收貨-項目" meta:resourcekey="lblSingleLineResource1"></asp:Label></td>
    </tr>
    <tr>
