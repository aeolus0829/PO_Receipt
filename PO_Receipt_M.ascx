    ...
    <tr>
        <td>
            <table>
                <tr>
                    <td>
                        <asp:Label ID="Label3" runat="server" Text="回傳物料文件:" Font-Bold="True" 
                            Font-Names="微軟正黑體" ForeColor="#666666"></asp:Label>
                            <span ondblclick="CopyToClipBoard2(<%=rematr.ClientID %>);"><asp:Label
                                    ID="rematr" runat="server" Font-Bold="True" Font-Names="微軟正黑體" ForeColor="Red"></asp:Label></span>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:PlaceHolder ID="PlaceHolder1" runat="server">
                            <asp:Label ID="Label2" runat="server" Text="103BPM單號:" Font-Bold="True" Font-Names="微軟正黑體"
                                ForeColor="#666666"></asp:Label><span ondblclick="CopyToClipBoard2(<%=lb103od.ClientID %>);"><asp:Label
                                    ID="lb103od" runat="server" Font-Bold="True" Font-Names="微軟正黑體" ForeColor="Red"></asp:Label></span>
                        </asp:PlaceHolder>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <asp:Button ID="btnDel" runat="server" Text="作廢RFC" Width="66px" OnClick="btnDel_Click"
                            Enabled="False" />
                    &nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnprint" runat="server" onclick="btnprint_Click" Text="列印" 
                            Enabled="False" Width="58px" />
                    </td>
                </tr>
            </table>
        </td>
