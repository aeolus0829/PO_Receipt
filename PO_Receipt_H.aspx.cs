...
public partial class WKF_OptionalFields_PO_Receipt_H : Fast.EB.Utility.BasePage
{
    ...
    {
        base.OnPreRender(e);
        UC_FiledDropList1.SelectedValue = "optionalField_PO_Receipt_H";
    }
    ...
    private bool UpdateField()
    {
        ...
        //外掛欄位型態(此欄位的值不可更改)
        fieldDr["FIELD_SECTYPE"] = "PO_Receipt_H";
